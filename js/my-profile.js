function saveProfile() { // Función que guarda el perfil del usuario hasta que se limpie el localStorage
  if ( // Tomo requeridos los datos siguientes
  ...
  } else { // Si completaron todo lo requerido armo el objeto información
    var info = {
...
function showProfile(info) {
  ...
  let html = "";
  if (info != undefined) { // Si está definido muestro los datos del perfil
    html =
      `
    <div class="row mt-2">
      <div class="col-md-6">
...
function showPhoto() { // Función que muestra la foto 
  ...
  } else { // Si no hay nada cargado mostramos el mensaje
...
document.addEventListener("DOMContentLoaded", function (e) {
  if (localStorage.getItem("info") != null) { // Si hay información en el objeto info:
